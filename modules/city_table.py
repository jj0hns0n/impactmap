...
def city_table(city_info,R):
    ...
    for i in xrange(8):
        ...
        os.system('cat << END >> cityinform.legend'+'\n'+
                  ...
                  'D 0 1p'+'\n'+
                  'END')               
    os.system('pslegend -Dx5.15i/6.0i/2.75i/1.92i/TL '+J+' '+R+' -F -K cityinform.legend > comp2.eps')
    os.system('ps2pdf14 -dPDFSETTINGS=/prepress -dEPSCrop comp2.eps')
    os.system('pdfcrop comp2.pdf comp2.pdf')
    os.system('rm cityinform.legend') 
    os.system('rm comp2.eps')
